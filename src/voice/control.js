...
export function createVoiceControl({ reset = false } = {}) {
    ...
    root.innerHTML = `
      <div class="gev-voice-heading">
        ...
        <div class="gev-voice-cost">
          <button id="gev-voice-fallback" class="gev-voice-tier-btn gev-voice-fallback-btn" type="button" aria-pressed="false" hidden title="Switch to local Piper voice — no cloud connection, reduced tools">LOCAL</button>
  ...
  return {
    ...
    fallbackButton: root.querySelector('#gev-voice-fallback'),
  };
}
